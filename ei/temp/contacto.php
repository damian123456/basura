...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="content-page in-contacto">
            ...
            <img src="img/firulete-contacto-2.png" alt="" class="firulete-inglaterra">
            <img src="img/firulete-quienes-3.png" alt="" class="firulete-argentina">
        </div>
        <div class="container">    
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                    <h1 class="titulo-seccion-tn margin-top-big">Contacto</h1>
                    <p class="bajada-tn">Escríbanos su pregunta o inquietud sobre los cursos, será respondido a la brevedad.</p>
