        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div class="container-galeria in-videos">
                        <iframe width="420" height="315" src="https://www.youtube.com/embed/GQI2Jgt5vOg?rel=0" frameborder="0" allowfullscreen></iframe>
                        <p class="descripcion">Clase Especial <br>
                                Primavera</p>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div class="container-galeria in-videos">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/8_i7Dxwlkco?rel=0" frameborder="0" allowfullscreen></iframe>
                        <p class="descripcion">Clase Especial <br>
                                Primavera</p>
                    </div>
                </div>
