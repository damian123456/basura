...
#inputs input
{
    background: #f1f1f1 url(./skin/default/images/login-sprite.png) no-repeat;
...
<form method="POST" action="login.php" id="login">
    ...
    <fieldset id="inputs">
        <input id="username" type="text" value="Vinaget" disabled="true">   
        <input name="secure" size="44" type="password" placeholder="Password" required>
    </fieldset>
    <fieldset id="actions">
