<?
    ...
    if(is_array($galeria)) {
        $fotos = $db->fetch_all("SELECT * FROM galerias_contenido where id_galeria=".$galeriaId. " order by archivo+0, archivo");
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ul class="nav nav-pills">
                        <li><a href="prensa.php">Fotos</a></li>
                        <li><a href="videos_prensa.php?id=<?php echo $galeriaId;?>">Videos</a></li> 
