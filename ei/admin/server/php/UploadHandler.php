...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/../../../uploads/galerias/',
            'upload_url' => $this->get_full_url().'/../../../uploads/galerias/',
            'user_dirs' => true,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function set_additional_file_properties($file) {
        ...
        $file->deleteUrl = $this->options['script_url']
            .$this->get_query_separator($this->options['script_url'])
            .$this->get_singular_param_name()
            .'='.rawurlencode($file->name).'&id_galeria='.$file->id_galeria;
