...
<form class="form-horizontal" id="form" role="form" method="post" action="" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" name="autor" id="autor" class="form-control" placeholder="Autor del libro" value="<?=getValue($item,'autor')?>" required>
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-2 control-label" for="title">Editorial</label>
		<div class="col-sm-10">
			<input type="text" name="editorial" id="editorial" class="form-control" placeholder="Editorial del libro" value="<?=getValue($item,'editorial')?>" required>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10 form-controls">
			<button type="button" onclick="location.href='libreria2.php'" class="btn btn-default" rel="external"><i class="fa fa-chevron-left"></i> Volver</button>
