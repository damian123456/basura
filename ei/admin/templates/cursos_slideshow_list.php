<div class="center">
	<a href="cursos_slideshow.php?action=new" class="btn-lg btn-primary"><i class="fa fa-plus"></i> Añadir Diapositiva</a>
</div>
...
<?	foreach($items as $k => $item){   ?>
			<tr id="cursoss_<?=$item['id']?>">
				...
				<td>
					...
					<a href="cursos_slideshow.php?id=<?=$item['id']?>" class="btn btn-primary"><span class="fa fa-edit"></span></a>
					<a href="cursos_slideshow.php?action=delete&id=<?=$item['id']?>" class="btn btn-danger" onClick="return confirm('¿Seguro que desea eliminar este item?');"><span class="fa fa-trash-o"></span></a>
				</td>
			</tr>
<?	} ?>
		</tbody>
