...
<form class="form-horizontal" id="form" role="form" method="post" action="" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" name="titulo" style="width:48%;" class="form-control" placeholder="Título" value="<?=getValue($item,'titulo')?>" required>
		</div>
	</div>
	...
	<div class="col-sm-10">
				<input type="text" name="contenido" style="width:48%;" class="form-control" placeholder="Subtítulo" value="<?=getValue($item,'contenido')?>" required>
	</div>
	</div>
