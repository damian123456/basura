<form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label">Boton</label>
		<label class="col-sm-1 control-label" for="green_btn_text">Texto</label>
		<div class="col-sm-3">
			<input type="text" class="form-control" id="green_btn_text" name="green_btn_text" placeholder="Texto del botón" value="<?=getValue($item,'green_btn_text')?>"  required>
		</div>
		<label class="col-sm-1 control-label" for="green_btn_url">URL</label>
		<div class="col-sm-5">
			<input type="text" class="form-control" id="green_btn_url" name="green_btn_url" placeholder="URL del botón" value="<?=getValue($item,'green_btn_url')?>"  required>
		</div>
	</div>
	<!--<div class="form-group">
