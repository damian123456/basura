    ...
    lang: {
      ...
      'es-ES': {
        font: {
          ...
          underline: 'Subrayado',
          strike: 'Tachado',
          clear: 'Remover Estilos',
          height: 'Alto de Linea',
          size: 'Tama\xF1o'
        },
        image: {
          image: 'Imagen',
          insert: 'Insertar Imagen',
          resizeFull: 'Redimensionar al 100%',
          resizeHalf: 'Redimensionar al 50%',
          resizeQuarter: 'Redimensionar al 25%',
          resizeOriginal: 'Tama\xF1o Original',
          floatLeft: 'Flotar a la Izquierda',
          floatRight: 'Flotar a la Derecha',
          floatNone: 'Sin Flotar',
          dragImageHere: 'Arrastre una imagen aqu\xED',
          selectFromFiles: 'Seleccione archivo',
        ...
        link: {
          ...
          url: 'A qu\xE9 URL deber\xEDa ir?',
        ...
        hr: {
          insert: 'Insertar L\xEDnea'
        },
        style: {
          style: 'Estilo',
					normal: 'Normal',
					section: 'Texto Azul',
          h2: 'T\xEDtulo Grande Rojo',
          h3: 'T\xEDtulo Peque\xF1o Rojo'
        },
        lists: {
        ...
        color: {
          ...
          setTransparent: 'Hacer Transparent',
          reset: 'Reiniciar',
          resetToDefault: 'Volver al color por defecto'
        },
        shortcut: {
          ...
          action: 'Acci\xF3n',
          paragraphFormatting: 'Formato de P\xE1rrafo',
  ...
  var Editor = function () {
    ...
    this.resize = function ($editable, sValue, elTarget) {
      ...
      if(sValue==0){
				...
				elTarget.style.width = 100 * sValue + '%';
      ...
      style: function (lang) {
        return '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" title="' + lang.style.style + '" data-toggle="dropdown" tabindex="-1"><i class="fa fa-magic icon-magic"></i> <span class="caret"></span></button>' +
               '<ul class="dropdown-menu">' +
                 ...
                 '<li><a data-event="formatBlock" data-value="section"><section>' + lang.style.section + '</section></a></li>' +
                ...
                '<div class="note-image-popover popover bottom in" style="display: none;">' +
                  ...
                  '<div class="popover-content note-image-content">' +
                    '<div class="btn-group">' +
                      ...
                      '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.image.resizeOriginal + '" data-event="resize" data-value="0" tabindex="-1"><span class="note-fontsize-10">Original</span> </button>' +
                    '</div>' +
                    '<div class="btn-group">' +
